...
ax.plot(numbers,my_list_of_numbers,   lw = 1, ls = "solid",   c = "red", label = "normal",)
ax.plot(numbers,my_list_of_numbers_2, lw = 2, ls = "dotted",  c = "green", label = "count+1",)
ax.plot(numbers,my_list_of_numbers_3, lw = 3, ls = "dashed",  c = "blue", label = "count+2",)
ax.plot(numbers,my_list_of_numbers_4, lw = 4, ls = "dashdot", c = "pink", label = "count+3",)
ax.plot(numbers,my_list_of_numbers_5, lw = 5, ls = "dotted",  c = "yellow", label = "count+4",)
